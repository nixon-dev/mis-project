                                ...
                                <div class="col-sm-12">
                                    ...
                                    <form role="form" action="{{ url('/staff/insert-document-action') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="history_date" class="form-control" onfocus="this.showPicker()" required>
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <h3 class="m-t-none m-b">Edit Amount</h3>

                                                            <form role="form"
                                                                action="{{ url('/staff/update-document-amount') }}"
                                                                method="POST">
                                                                @csrf()
...
@section('script')
    ...
    <script>
        ...
        function updateStatus(itemId, isChecked) {
            ...
            $.ajax({
                method: 'POST',
                url: '/staff/document/update-status',
                data: {
